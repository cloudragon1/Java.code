<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="城市总销量" prop="sales">
        <el-input
    ...
    <el-table v-loading="loading" :data="cityList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="城市总销量" align="center" prop="sales" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="城市总销量" prop="sales">
              <el-input v-model="form.sales" placeholder="请输入城市总销量" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        sales: [
          { required: true, message: "城市总销量不能为空", trigger: "blur" }
        ]
      }
    }
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除城市统计分析编号为"' + ids + '"的数据项？').then(function() {
        return delCity(ids)
      }).then(() => {
        this.getList()
