<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="车辆用途" prop="useFor">
        <el-input
    ...
    <el-table v-loading="loading" :data="usageList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="车辆用途" align="center" prop="useFor" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          <el-col :span="24">
            <el-form-item label="车辆用途" prop="useFor">
              <el-input v-model="form.useFor" placeholder="请输入车辆用途" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="总销量" prop="sales">
...
<script>
import { listUsage, getUsage, delUsage, addUsage, updateUsage } from "@/api/usage/usage"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除车辆用途分布统计编号为"' + ids + '"的数据项？').then(function() {
        return delUsage(ids)
      }).then(() => {
        this.getList()
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('usage/usage/export', {
        ...this.queryParams
